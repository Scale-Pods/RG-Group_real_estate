...
import { getMockEmailBounces } from '@/lib/mock-data';
...
export async function GET() {
    ...
    // No Instantly key configured (demo/mock mode) — return realistic bounce
    // data instead of a 500 so the dashboard still renders.
    if (!apiKey) {
        return NextResponse.json(getMockEmailBounces());
    }
