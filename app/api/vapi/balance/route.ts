...
import { MOCK_VAPI_BALANCE, MOCK_ELEVENLABS_BALANCE } from '@/lib/mock-data';
...
export async function GET() {
    ...
    if (elApiKey) {
        ...
        // No ElevenLabs key (demo/mock mode) — show a plausible usage figure.
        elData = MOCK_ELEVENLABS_BALANCE;
    }
    ...
    if (vapiPrivKey) {
        ...
        // No VAPI key (demo/mock mode) — show a plausible balance.
        vapiData = MOCK_VAPI_BALANCE;
    }
