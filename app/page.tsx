                    ...
                    <div className="flex items-center gap-3">
                        ...
                        >
                            <div className="relative w-[136px] h-[24px]">
                                <Image src="/RG-Group-Logo.png" alt="RG Group Dubai Logo" fill className="object-contain" priority />
                            </div>
                        </div>
                        <div style={{ width: 1, height: 20, background: 'rgba(255,255,255,0.12)' }} />
                        <span style={{ fontSize: 12, fontWeight: 500, color: 'rgba(255,255,255,0.40)', letterSpacing: '-0.01em' }}>
                            Powered by{' '}
                            <Image src="/scalepods-logo.avif" alt="ScalePods" width={60} height={16} style={{ display: 'inline-block', verticalAlign: 'middle', width: 'auto', height: 16 }} />
                        </span>
                    </div>
                        ...
                        <div style={{
                            ...
                            <div className="flex flex-col items-center pb-6 pt-2 text-center">
                                <div className="bg-white rounded-xl px-6 py-3 mb-4 shadow-sm inline-block">
                                    <Image src="/RG-Group-Logo.png" alt="RG Group Dubai Logo" width={158} height={24} className="h-7 w-auto object-contain" />
                                </div>
