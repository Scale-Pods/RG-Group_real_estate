        ...
        <>
            ...
            <td style={{ padding: '10px 14px' }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                    ...
                    {call.vapiAccount && (call.vapiAccount || '').toUpperCase() === 'B2B' && (
                        <span style={{ display: 'inline-flex', alignItems: 'center', padding: '2px 7px', borderRadius: 'var(--radius-xs)', fontSize: 9, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.04em', background: 'rgba(10,132,255,0.10)', color: 'var(--blue)' }}>
                            B2B
                        </span>
                    )}
                    {call.vapiAccount && (call.vapiAccount || '').toUpperCase() === 'B2C' && (
                        <span style={{ display: 'inline-flex', alignItems: 'center', padding: '2px 7px', borderRadius: 'var(--radius-xs)', fontSize: 9, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.04em', background: 'rgba(48,209,88,0.10)', color: 'var(--green)' }}>
                            B2C
                        </span>
                    )}
                </div>
