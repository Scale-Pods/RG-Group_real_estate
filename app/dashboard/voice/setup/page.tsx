                    ...
                    <Card className="border-slate-200">
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input defaultValue="Senior Consultant at RG Group Dubai" />
                            </div>
                            <div className="grid gap-2">
                                <Label>Opening Greeting</Label>
                                <Input defaultValue="Hello, this is Fatima from RG Group Dubai. I noticed you were interested in our solutions." />
                            </div>
                        </CardContent>
                    </Card>
                </TabsContent>
